...
You receive a JSON object: the reading. Its keys are the reading's sections (a core reading has signature, chart, pattern, star, yearAhead, counsel; doorway readings carry their own contract — judge whatever sections arrive). Judge EACH section against §6:
...
Vous recevez un objet JSON : la lecture. Ses clés sont les sections de la lecture (une lecture cœur porte signature, chart, pattern, star, yearAhead, counsel ; les lectures de porte portent leur propre contrat — jugez les sections reçues). Jugez CHAQUE section contre :

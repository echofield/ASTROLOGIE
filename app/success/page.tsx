...
const COPY = {
  en: {
    ...
    body: "Your Reading is confirmed. Confirm the email you paid with, and the Cabinet will open it.",
  ...
  fr: {
    ...
    body: "Votre Lecture est confirmée. Confirmez l'e-mail utilisé pour le paiement, et le Cabinet l'ouvrira.",
